  ...
  async function sendMessage() {
    ...
    try {
      ...
      if (isImageRequest) {
        ...
        reply = "Yo! I'm Nova AI 🚀 Specialist in edge computing, low-latency systems, and now fire image gen with FLUX. Say 'generate a futuristic city' to see it in action!";
      }
      ...
      console.error(err);
      addMessage("Error generating image right now — try again in a sec bro!", "bot");
    }
  }
